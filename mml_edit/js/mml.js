 ...
 * @param author the human author name
 * @param work the name of the work
 */
function MMLEditor(target, docid, version1, author, work) {
    ...
    this.author = author;
    /** the human readable name of the work */
    this.work = work;
    /**
...
jQuery(document).ready(
    function(){
        ...
        var editor = new MMLEditor(params['target'],params['docid'],
            params['version1'],params['author']);
    }
);
