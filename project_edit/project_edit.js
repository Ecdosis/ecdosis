 ...
 */
function project_edit(target,docid,users)
{
    this.target = target;
    ...
    this.user_select = function(users)
    {
        var uarray = users.split('$');
        var html = '<select name="user" id="user">';
    ...
    {    
        ...
        html += '<tr><td>Owner:</td>';
        html += '<td>'+self.user_select(users);
        html += '</td></tr>';
...
jQuery(document).ready( 
    function(){
        ...
        var editor = new project_edit(params['target'],params['docid'],params['editors']);
    }
); 
